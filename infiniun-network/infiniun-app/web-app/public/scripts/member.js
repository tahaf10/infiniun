    ...
    success: function(data) {
      ...
      if (data.error) {
        ...
        $('.heading').html(function() {
          ...
          str = str + '<h2><b>' + data.contact + '</b></h2>';
          str = str + '<h2><b>' + data.description + '</b></h2>';
          console.log(data);
          return str;
        });
      ...
      //     var patientsData = data.patientData;
      //     for (var i = 0; i < patientsData.length; i++) {
      //       str = str + '<option partner-id=' + patientsData[i].id + '> ' + patientsData[i].name + '</option>';
      //     }
      //     return str;
      //   });
