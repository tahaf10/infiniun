...
console.log(apiUrl+"at register.js");
...
$('.register-partner').click(function() {
  ...
  var formContact = $('.contact input').val();
  var formPartnerId = $('.partner-id input').val();
  var formCardId = $('.card-id input').val();

  //create json data
  var inputData = '{' + '"name" : "' + formName + '", ' + '"partnerid" : "' + formPartnerId + '", ' + '"cardid" : "' + formCardId + '",'+ '"contact" : "' + formContact + '"}';
  console.log(inputData)
...
$('.register-labs').click(function() {
  ...
  //create json data
  var inputData = '{' + '"contact" : "' + formName + '", ' + '"partnerid" : "' + formPartnerId + '", ' + '"cardid" : "' + formCardId + '"}';
  console.log(inputData)

  //make ajax call to add the dataset
  $.ajax({
    type: 'POST',
    url: apiUrl + 'registerLabs',
    data: inputData,
    dataType: 'json',
    contentType: 'application/json',
    beforeSend: function() {
